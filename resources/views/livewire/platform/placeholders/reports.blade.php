<div class="animate-pulse space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        @for($i = 0; $i < 4; $i++)
            <div class="bg-[#0e0735] border border-[#1e164e] rounded-xl p-5 flex items-center gap-4">
                <div class="w-12 h-12 bg-[#1a0e40] rounded-xl animate-shimmer"></div>
                <div class="space-y-2 flex-1">
                    <div class="h-4 w-20 bg-[#1a0e40] rounded"></div>
                    <div class="h-3 w-32 bg-[#1a0e40] rounded"></div>
                </div>
            </div>
        @endfor
    </div>
